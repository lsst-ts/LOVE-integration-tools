      ...
      steps {
        script {
          sshagent(credentials: ['love-ssh-key-2']) {
            ...
            sh 'scp -o StrictHostKeyChecking=no -r deploy/linode/simulatorcamera.py love@love.love.inria.cl:.'
            sh 'scp -o StrictHostKeyChecking=no -r jupyter love@love.love.inria.cl:.'
